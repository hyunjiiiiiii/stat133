...
```{r}
# your code
substr(states, start = num_chars - 2, stop = num_chars)
```
...
# your code
states_list <- list()
for (i in 4:max(num_chars)){
  if (i %% 2 == 0){
    states_list <- c(states_list, 
                     toupper(paste(states[num_chars == i], collapse = ", ")))
  }
  else{
    states_list <- c(states_list,
                     tolower(paste(states[num_chars == i], collapse = ", ")))
  }
}

names(states_list) <- c("4-char", "5-char", "6-char", "7-char", "8-char", "9-char", "10-char", "11-char", "12-char", "13-char", "14-char")
...
```{r}
# your code
files <- paste(paste("file", 1:10, sep = ""), "csv", sep = ".")
```
