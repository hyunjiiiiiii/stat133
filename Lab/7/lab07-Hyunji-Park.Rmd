...
```{r}
even_name <- name[seq(2, length(name), 2)]
odd_height <- height[seq(1, length(height), 2)]
five_sex <- sex[seq(5, length(sex), 5)]
position_mass <- mass[seq(10, length(mass), 10)]
rev_name <- rev(even_name)
```
