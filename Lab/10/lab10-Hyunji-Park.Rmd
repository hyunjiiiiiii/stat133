...
- This lab consists of two parts: 1) writing some functions, and 2) shiny apps.
...
```{r}
# your code
futuer_value <- function(principal = 1000, rate = 0.01, years = 1){
...
```{r}
# your code
futuer_value(principal = 1000, rate = 0.02, years = 5)
```
...
```{r}
# your code
annuity <- function(pmt = 1000, rate = 0.01, years = 1, due = FALSE){
  ann <- pmt * ((1 + rate)^years - 1) / rate
  if (due) {
    ann <- ann * (1 + rate)
  }
  return (ann)
...
```{r}
# your code
annuity(pmt = 1200, rate = 0.06, years = 10)
```
...
```{r}
# your code
annuity(pmt = 1200, rate = 0.06, years = 10, due = TRUE)
```
