...
tweets %>%
  group_by(sentiment) %>%
  summarise(
    avg_lower = mean(str_count(content, "[[:lower:]]")),
    avg_upper = mean(str_count(content, "[[:upper:]]")),
    avg_digit = mean(str_count(content, "[[:digit:]]")),
    avg_punct = mean(str_count(content, "[[:punct:]]")),
    avg_space = mean(str_count(content, "[[:space:]]"))
  )
```
